      ...
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          ...
          <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                  <img className='w-30 mx-auto' src={Docker} alt="HTML icon" />
              ...
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                  <img className='w-30 mx-auto' src={GCP} alt="HTML icon" />
                  <p className='my-4'>GCP</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                  <img className='w-20 mx-auto' src={DO} alt="HTML icon" />
                  <p className='my-4'>DO</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                  <img className='w-50 mx-auto' src={CICD} alt="HTML icon" />
                  <p className='my-4'>CICD</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
